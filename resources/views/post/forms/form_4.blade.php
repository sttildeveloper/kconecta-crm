...
<form action="{{ url('/post/create') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container-main">
        ...
        <h2 class="title-main-row-section">CaracterÃ­sticas del garaje</h2>
        <div class="container-row-form box">
            <!-- <div class="div-col-1 container-for-sale-only">
            ...
            <label for="">
                <span class="title-label">AÃ±o de construcciÃ³n del garaje</span>
            ...
            <div class="div-col-1">
                <span class="title-label">CaracterÃ­sticas</span>
