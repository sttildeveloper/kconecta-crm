...
@section('title', 'Kconecta - Casa r̼stica')
...
@section('subheading')
    Completa los datos para registrar Casa r̼stica
@endsection
...
<form action="{{ url('/post/create') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container-title-page">
        <h2>Complete los datos para registrar &raquo; <span>Casa r̼stica</span></h2>
    </div>
