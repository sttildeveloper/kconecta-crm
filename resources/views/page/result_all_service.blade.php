                        ...
                        content: `
                            <div class="container-map-details-info-app-main">
                                ...
                                <div class="service-rating-chip">
                                    <span class="service-rating-chip__stars">${Number(location.ratings_count || 0) > 0 ? `${Number(location.average_stars || 0).toFixed(1)} &starf;` : `Sin valoraciones`}</span>
                                    <span class="service-rating-chip__count">${Number(location.ratings_count || 0) > 0 ? `(${Number(location.ratings_count)} resenas)` : ``}</span>
                                </div>
