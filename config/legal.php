...
return [
    ...
    'responsible_name' => env('LEGAL_RESPONSIBLE_NAME', 'Kconecta'),
    'responsible_tax_id' => env('LEGAL_RESPONSIBLE_TAX_ID', 'Pendiente de definir'),
    'responsible_address' => env('LEGAL_RESPONSIBLE_ADDRESS', 'Pendiente de definir'),
    ...
    'jurisdiction' => env('LEGAL_JURISDICTION', 'España'),
